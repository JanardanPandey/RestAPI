"""
Django settings for ConcreateApiView project.
...
SECRET_KEY = 'django-insecure-96k)@_b*9n+j3cldewxm6$osipd@bv(nkhp961^-&q!ah4g6pz'
...
ROOT_URLCONF = 'ConcreateApiView.urls'
...
WSGI_APPLICATION = 'ConcreateApiView.wsgi.application'
