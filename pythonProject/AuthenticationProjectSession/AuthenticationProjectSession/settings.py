...
SECRET_KEY = 'django-insecure-x$e=mmjn65%xm&7op-51u#o(&8y1a(bv$)eett1prvjkw5&4hl'
...
INSTALLED_APPS = [
    ...
    'AuthenticationProjectSessionApp',
    'rest_framework',
]
...
ROOT_URLCONF = 'AuthenticationProjectSession.urls'
...
WSGI_APPLICATION = 'AuthenticationProjectSession.wsgi.application'
