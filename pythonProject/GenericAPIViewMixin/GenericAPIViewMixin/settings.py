...
SECRET_KEY = 'django-insecure-ml^upi9dm+5!ui@u$td$)@co5@!+)dy=do-+)!d&0%xd@_hj*b'
...
ROOT_URLCONF = 'GenericAPIViewMixin.urls'
...
WSGI_APPLICATION = 'GenericAPIViewMixin.wsgi.application'
